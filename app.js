...
function createTeamTableWrapper() {
  ...
  table.innerHTML = `
    <thead>
      <tr>
        <th style="width: 13%">대분류</th>
        <th style="width: 11%">중분류</th>
